...
`DivinationScreen` starts drafts, records three-card selection, renders result markdown/summary, toggles saved-history visibility, and loads saved history through `deepReadingControllerProvider`.
